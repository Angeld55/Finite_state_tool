...
//}
//class TransitionCommand : public Command // arc A 0 3 b
//										 // arc P 0, 'a', '#', 0, "A#"
//{
//	std::string execute(const std::vector<std::string>& args)
//	{
...
//{
//	std::string execute(const std::vector<std::string>& args)  // add_state A
//	{
//		FiniteStateAutomation fs;
//		if (dispatcher->env.getFSA(args[1], fs) == 0)
//		{
...
//{
//	std::string execute(const std::vector<std::string>& args)  // make_final A 3
//	{
//		FiniteStateAutomation fs;
//		NPDA pa;
...
//	}
//};
//class AcceptsCommand : public Command // accepts A aabba
//{
//	std::string execute(const std::vector<std::string>& args)  
//	{
//		FiniteStateAutomation fs;
